...
(function () {
    ...
    const dueDateTask = document.querySelector('#dueDateTask');
    ...
    function displayTask() {
        ...
        renderTaskGroup(todoTasks, document.querySelector('#todoColumn'));
        renderTaskGroup(progressTasks, document.querySelector('#inProgressColumn'));
        renderTaskGroup(completedTasks, document.querySelector('#completedColumn'));
    }
    function clearForm() {
        taskForm.reset();
        titleTask.value = '';
    ...
    function changeStateFun(state, id) {
